        ...
        return (
            <div className="custom-border">
                <div className="container" style={{marginTop: "2.5rem"}}>
                    ...
                    <div>
                        <ul>
                            <li><h5>{profile.socialMedia.facebook}</h5></li>
                            <li><h5>{profile.socialMedia.instagram}</h5></li>
                            <li><h5>{profile.socialMedia.twitter}</h5></li>
                            <li><h5>{profile.socialMedia.youtube}</h5></li>
                            <li><h5>{profile.socialMedia.linkedin}</h5></li>
                        </ul>
                    </div>
                    <br/>
                    <button className="btn btn-primary" onClick={this.showModal}>Edit Profile</button>
                    <Popconfirm
        ...
        return (
            <div className="container">
                ...
                <Fragment>
                    ...
                    <Link className="btn btn-primary" to="/dashboard/addProfile">Create a profile</Link>
                </Fragment>
                )}
                <Modal 
                title="Basic Modal" 
